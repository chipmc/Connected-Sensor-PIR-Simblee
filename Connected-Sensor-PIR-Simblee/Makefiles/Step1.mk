...
#            ARDUINO_180_APP = $(APPLICATIONS_PATH)/ArduinoCC.app
#        endif
#    endif
#endif
#
...
#            ARDUINO_180_APP = $(APPLICATIONS_PATH)/Genuino.app
#        endif
#    endif
#endif
...
#ENERGIA_APP      = $(APPLICATIONS_PATH)/Energia-17.app
...
# Additional boards for Arduino 1.6.5 Boards Manager
# ----------------------------------
# Unified Arduino.app for Arduino.CC and Genuino, Arduino.ORG boards
...
#
REDBEARLAB_AVR_1    = $(ARDUINO_180_PACKAGES_PATH)/RedBearLab
REDBEARLAB_NRF_1    = $(ARDUINO_180_PACKAGES_PATH)/RedBearLab
...
# ~
            ...
            include $(MAKEFILE_PATH)/EnergiaCC2600EMT_18.mk
        else ifneq ($(call PARSE_FILE,$(BOARD_TAG),name,$(ENERGIA_18_C2000_BOARDS)),)
            include $(MAKEFILE_PATH)/EnergiaC2000_18.mk
# ~~
